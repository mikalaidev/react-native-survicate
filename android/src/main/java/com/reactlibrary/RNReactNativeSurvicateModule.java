...
public class RNReactNativeSurvicateModule extends ReactContextBaseJavaModule {

  private final ReactApplicationContext reactContext;

  public RNReactNativeSurvicateModule(ReactApplicationContext reactContext) {
    super(reactContext);
